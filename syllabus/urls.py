...
urlpatterns = [
    ...
    # Partial Updates
    url(r'^modules/reorder/$', views.modules_reorder, name='modules-reorder'),
    # REST API for Lesson
    ...
    url(r'^lessons/reorder/$', views.lessons_reorder, name='lessons-reorder'),
    # REST API for Unit
    ...
    # Partial Updates
    url(r'^units/reorder/$', views.units_reorder, name='units-reorder'),
]
